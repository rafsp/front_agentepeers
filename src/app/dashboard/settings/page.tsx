...
import { ArrowLeft, Building2, Upload, Settings, Trash2 } from 'lucide-react'
      ...
      <header className="border-b">
        <div className="container mx-auto px-4 py-4">
          ...
          <p className="text-muted-foreground">
            Configure as políticas, logo e diretrizes da sua empresa para análises personalizadas
          </p>
        </div>
      </header>
