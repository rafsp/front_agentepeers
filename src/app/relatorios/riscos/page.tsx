...
function RiscosContent(): React.ReactElement {
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-slate-50">
        <div className="text-center">
          ...
          <p className="text-slate-500">Carregando riscos e premissas...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-slate-50">
        <div className="text-center max-w-md">
          ...
          <p className="text-slate-500 mb-4">Selecione um projeto na pagina de relatorios para visualizar os riscos.</p>
